...
def calc_eval(exp):
    ...
    if isinstance(exp, Pair):
        operator = exp.map(calc_eval).first # UPDATE THIS FOR Q2
        ...
        return calc_eval(bindings[exp]) if exp in bindings else exp # UPDATE THIS FOR Q4
