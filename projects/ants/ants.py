...
class Ant(Insect):
    ...
    def add_to(self, place):
        if place.ant is None:
            ...
            # BEGIN Problem 8b
            if place.ant.is_container and place.ant.can_contain(self) and not self.is_container:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while current_place.bees == []:
            current_place = current_place.entrance
            count += 1
            if current_place.is_hive or count > self.upper_bound - self.lower_bound:
                return None
    ...
    def action(self, gamestate):
        ...
        while current_place.exit != None:
            ...
            if current_place.ant != None:
                ...
                if current_place.ant.is_container and current_place.ant.ant_contained != None:
